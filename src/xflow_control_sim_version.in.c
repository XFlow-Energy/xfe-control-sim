/**
 * @file    xflow_control_sim_version.c
 * @author  XFlow Energy
 * @date    2025
 * @brief   XFLOW-CONTROL-SIM Git version.
 */
...
// @git_commit_info_xflow_control_sim_warning@
#define GIT_COMMIT_INFO_XFLOW_CONTROL_SIM "$$Revision: @git_commit_info_xflow_control_sim@ $$"
...
const char gitCommitInfoXfeControlSim[] = GIT_COMMIT_INFO_XFLOW_CONTROL_SIM;